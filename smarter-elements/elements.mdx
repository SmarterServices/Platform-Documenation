...
- **[Builder](/smarter-elements/elements/blockkit-playground)** - Interactive editor for creating, testing, and previewing BlockKit JSON structures with real-time rendering and validation
...
|---------|------|-------------|
| [Builder](/smarter-elements/elements/blockkit-playground) | `blockkit/builder` | Interactive editor for creating, testing, and previewing BlockKit JSON structures with real-time rendering and validation |
